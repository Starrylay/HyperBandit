...
class FactorUCBAlgorithm:
    def __init__(self,W_type = "None", init='zero', window_size=1, max_window_size=10):  # n is number of users

        self.alpha = config.FactorUCB_setting.alpha
        self.alpha2 = config.FactorUCB_setting.alpha2
        self.item_num = config.FactorUCB_setting.item_num
        self.latent_dimension = config.FactorUCB_setting.item_latent_dimension
        self.observed_dimension = config.FactorUCB_setting.item_observed_dimension
        self.item_dimension = config.FactorUCB_setting.item_dimension
        self.lambda_ = config.FactorUCB_setting.lambda_
        self.cluster_num = config.FactorUCB_setting.cluster_num
        if W_type == "Have":
        ...
        self.USERS = FactorUCBUserStruct(self.observed_dimension, self.latent_dimension, self.lambda_, self.cluster_num, self.W, init="zero")
        self.articles = []
