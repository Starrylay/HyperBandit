...
class AdaptiveThompsonUserStruct:
    ...
    def updateParameters(self, articlePicked_FeatureVector, click):
        ...
        self.B = 0.99 * self.B + np.outer(articlePicked_FeatureVector, articlePicked_FeatureVector.T)
        self.f = 0.99 *self.f + np.multiply(articlePicked_FeatureVector, click)
...
class AdaptiveThompson:
    def __init__(self,setting ):  # n is number of users
        ...
        self.AdTS_Window = 200 
        self.AdTS_CheckInter = 50
        self.v = 0.4
