...
class CLUBAlgorithm(BaseAlg):
	def __init__(self):
		self.dimension = config.CLUB_setting.item_dimension
		self.time = 0
...
# scp -P 5102 weicong_qin@183.174.228.159:/home/weicong_qin/uot-match/models/sinkhorn_uot.py /new_disk2/chenglei_shen/PyProject
