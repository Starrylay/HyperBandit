...
class DLinUCBAlgorithm:
    def __init__(self):  # n is number of users #, dimension, alpha, lambda_, NoiseScale, tau, delta_1=1e-2, delta_2=1e-1, tilde_delta_1=1e-2,eta=0.3
        self.dimension = config.dLinUCB_setting.item_dimension
        self.alpha = config.dLinUCB_setting.alpha
        self.lambda_ = config.dLinUCB_setting.lambda_
        self.global_time = 0
        self.users = {}
        self.NoiseScale = config.dLinUCB_setting.NoiseScale
        self.ObservationInterval = config.dLinUCB_setting.tau  # Size of the slding window
        self.delta_1 = config.dLinUCB_setting.delta_1
        self.delta_2 = config.dLinUCB_setting.delta_2
        self.tilde_delta_1 = config.dLinUCB_setting.tilde_delta_1  # self.tilde_delta_1 is between 0 and self.delta_1
        self.eta = config.dLinUCB_setting.eta  # self.eta is between 0 and 1
